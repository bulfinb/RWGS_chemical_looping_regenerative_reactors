...
mpl.rcParams['axes.prop_cycle'] = mpl.cycler(color= plt.cm.viridis(np.linspace(0, 1, 8)))



filename1 = os.path.join("exported_data","RWGS_demo_CeO2_cycle1_H2-flow_d_vs_x.txt")
filename2 = os.path.join("exported_data","RWGS_demo_CeO2_cycle1_H2-flow_xH2O_vs_x.txt")
filename3 = os.path.join("exported_data","RWGS_demo_CeO2_cycle1_H2-flow_deq-d_vs_x.txt")
#correction = "ExpDat_SA_oxygen_correction.txt"
collumn_names= ['x0', 't = 0 s',  '80', '160', '240', '320', '400', '480', '521']
y_cols =  ['t = 0 s',  '80', '160', '240', '320', '400', '480', '521']
times = [0, 80, 160, 240, 320, 400, 480, 521]
...
filename4 = os.path.join("exported_data","RWGS_demo_CeO2_cycle1_H2-flow_xH2O_out_vs_t.txt")
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_d_vs_x.png'), dpi=400, bbox_inches='tight')
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_d_vs_x.pdf'), bbox_inches='tight')
plt.show()
...
#plt.legend()
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_xH2O_vs_x.png'), dpi=400, bbox_inches='tight')
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_xH2O_vs_x.pdf'), bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_deq-d_vs_x.png'), dpi=400, bbox_inches='tight')
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_deq-d_vs_x.pdf'), bbox_inches='tight')
plt.show()
...
#plt.legend()
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_xH2O_out_vs_t.png'), dpi=400, bbox_inches='tight')
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_H2-flow_xH2O_out_vs_t.pdf'), bbox_inches='tight')
plt.show()
