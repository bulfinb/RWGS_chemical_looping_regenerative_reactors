...
filename3 = os.path.join("exported_data","RWGS_demo_CeO2_cycle1_CO2-flow_d-deq_vs_x.txt")
#correction = "ExpDat_SA_oxygen_correction.txt"
collumn_names= ['x0', 't = 0 s',  '80', '160', '240', '320', '400', '436.6']
y_cols =  ['t = 0 s',  '80', '160', '240', '320', '400', '436.6']
times = [0, 80, 160, 240, 320, 400, 436.6]
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_d_vs_x.png'), dpi=400, bbox_inches='tight')
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_d_vs_x.pdf'), bbox_inches='tight')
plt.show()
...
#plt.legend()
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_xCO2_vs_x.png'), dpi=400, bbox_inches='tight')
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_xCO2_vs_x.pdf'), bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_d-deq_vs_x.png'), dpi=400, bbox_inches='tight')
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_d-deq_vs_x.pdf'), bbox_inches='tight')
plt.show()
...
#plt.legend()
plt.tight_layout()
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_xCO_out_vs_t.png'), dpi=400)
plt.savefig(os.path.join('plots', 'ESI_mod_cycle1_CO2-flow_xCO_out_vs_t.pdf'))
plt.show()